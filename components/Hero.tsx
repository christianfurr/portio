  ...
  return (
    ...
    >
      <div className="relative mx-auto w-full max-w-[1200px]">
        ...
        />
        <div
          className="absolute right-0 top-1/3 h-[380px] w-[380px] -translate-y-1/2 rounded-full bg-glow-royal/16 blur-3xl"
          aria-hidden
        />
        <div className="relative flex flex-col-reverse items-center gap-12 md:flex-row md:items-center md:justify-between">
          ...
          {hero.portraitUrl && (
            ...
            >
              ...
              <div className="absolute -inset-2 rounded-full bg-gradient-to-br from-accent via-glow-royal to-accent opacity-50 blur-xl" />
